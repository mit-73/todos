  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Dark theme shadows
        'neumorphic-outset-dark': '9px 9px 18px #24282e, -9px -9px 18px #34383e',
        'neumorphic-inset-dark': 'inset 9px 9px 18px #24282e, inset -9px -9px 18px #34383e',
        'neumorphic-outset-sm-dark': '4px 4px 8px #24282e, -4px -4px 8px #34383e',
        'neumorphic-inset-sm-dark': 'inset 4px 4px 8px #24282e, inset -4px -4px 8px #34383e',
      },
    },
  },
  plugins: [],
